...
def walkthrough_config(folder: Path, details: dict[str, Any], model_file: str = "house.glb") -> dict[str, Any]:
    ...
    config: dict[str, Any] = {
        ...
        "exterior_distance_scale": nested(details, "exterior_distance_scale", 1.08),
        "exterior_screen_fill": nested(details, "exterior_screen_fill", 0.78),
        "exterior_elevation_degrees": nested(details, "exterior_elevation_degrees", 22),
        "exterior_angle_degrees": nested(details, "exterior_angle_degrees", 0),
        "exterior_target_height_ratio": nested(details, "exterior_target_height_ratio", 0.30),
        "exterior_include_site": nested(details, "exterior_include_site", True),
        "exterior_front_direction": nested(details, "exterior_front_direction", None),
        "land_match": nested(details, "land_match", ["site", "terrain", "lawn", "ground", "driveway", "walkway", "sidewalk", "patio", "terrace", "deck", "hardscape"]),
        "min_fly_height": nested(details, "min_fly_height", 0.25),
        "max_fly_height": nested(details, "max_fly_height", None),
        "max_fly_height_ratio": nested(details, "max_fly_height_ratio", 0.58),
